...
[b]The rail[/b]: enemies reinforce 2 per turn into their front gaps. Your own men come over with the turn's opening, free — and the Reinforce card is a second crossing in the same turn, Trade Places a second swap. The reserve itself never fights and is never hit. Your captain and his prowman are alternates: one of them always holds the field, and only Trade Places trades them, so the waiting one shows dimmed on your rail. Retreat is always on the table — a live crew beats a dead legend."""
